...
// Composed helper: given a valid access token + realmId, a client, and line
// items, does the full customer-lookup -> item-lookup -> invoice-create dance.
// Used by both the manual sync-invoice endpoint and the quote-accepted trigger.
async function createInvoice(accessToken, realmId, client, items, docNumber) {
